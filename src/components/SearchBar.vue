<template>
  <section class="flex backdrop-blur-sm h-fit my-auto md:text-xl lg:text-4xl rounded-lg border border-white
    ...
    <input class="bg-white/20 rounded-l-lg p-3 h-1/2 hover:bg-white/40 focus:outline-none focus:bg-white/60 transition-all placeholder:text-white/40" v-model="cityName" placeholder="City Name" @keyup="keyboardPress($event)">
