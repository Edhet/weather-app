...
<template>
  <main class="min-w-screen min-h-screen flex justify-center text-white fill-white transition-all" v-bind:class="state.backgroundColor">
    <div class="absolute flex mt-4 z-0">
    ...
    <template v-else>
      ...
      <city-information class="entering-animation z-10" v-bind:city-info="apiResponse" @closeInfo="closeInformation()" v-else></city-information>
    </template>

    <a class="absolute flex mb-4 bottom-0 p-1 rounded-full hover:bg-white/40 focus:outline-none focus:bg-white/60 transition-all z-0" href="https://github.com/Edhet/weather-app" target="_blank">
